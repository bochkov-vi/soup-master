...
@Route(value = "admin/users/students/group/add", layout = MainLayout.class)
public class AddStudentGroupView extends StudentView {
	...
	protected void createForm(Div innerBlock) {
		...
		studentGroupBinder.forField(speciality)
