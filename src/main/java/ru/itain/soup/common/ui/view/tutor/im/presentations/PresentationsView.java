...
public class PresentationsView extends InteractiveMaterialsView implements BeforeEnterObserver {
	...
	private void editTopic() {
		List<MaterialTopic> topics = materialTopicRepository.findAll();
		new SoupElementEditDialog<MaterialTopic>(topics, "РЕДАКТИРОВАНИЕ ТЕМ") {
			@Override
	...
	private void updateTree() {
		...
		// обновляем данные
		treeData.clear();
		allTopics = materialTopicRepository.findAll();
