...
import ru.itain.soup.common.security.Roles;
...
@Secured(Roles.ROLE_TUTOR)
@Route(value = "tutor/users/students/group", layout = MainLayout.class)
@PageTitle(PAGE_TITLE)
public class StudentGroupView extends PersonalsView implements HasUrlParameter<Long> {
	...
	public StudentGroupView(
		...
		deleteElement.addClickListener(e -> {
			SoupBaseDialog dialog = new SoupBaseDialog(ok -> {
				...
				UI.getCurrent().navigate(PersonalsView.class);
