...
public class SyllabusAddView extends CommonView {
    ...
    public SyllabusAddView(SyllabusRepository syllabusRepository, CycleRepository cycleRepository, DepartmentRepository departmentRepository, DisciplineRepository disciplineRepository, SpecialityRepository specialityRepository) {
